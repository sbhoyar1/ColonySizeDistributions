function [I_adj, I_bin] = lung_colony_preprocess_set2_RFP_test(I)
...
I_adj = imadjust(I_adj, stretchlim(I, 0.0002));
%figure, imshow(I_adj), title('RFP Contrast adjust');

I_bin = imbinarize(I_adj, 0.40);
%figure, imshow(I_bin), title('RFP  thresholding');
