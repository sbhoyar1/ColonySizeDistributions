...
%     title('Histogram of GFP Met Area');
    ...
    [GFP_smallmet_data_updated, RFP_smallmet_data_updated] =            ...
        ...
        %% Save Cartoon Images
    RFP_bin = RFP_bin + RFP_bin_small; clear RFP_bin_small
    GFP_bin = GFP_bin + GFP_bin_small; clear GFP_bin_small
    [RG_cart, ~, ~] = lung_cartoon(RFP_bin, GFP_bin);
   
    imwrite(RG_cart, 'RG_cart.tif', 'tiff')
    %imwrite(G_cart, 'Green.tif', 'tiff')
    %clear RG_cart

    clear RFP_bin GFP_bin R_cart G_cart RG_cart
...
% disp(N)
 %labels = {'FolderName.', 'Day', 'Mouse', 'GFP_mets', 'RFP_mets', 'GFP_smallmets', 'RFP_smallmets', 'Median GFP met area', 'Median RFP met area', 'Mean GFP met area', 'Mean RFP met area'};
